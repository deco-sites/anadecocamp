    ...
    <div>
      <div class="mx-auto flex flex-col items-center gap-8">
        ...
        >
          ...
          >
            <div
              class="inline-block text-5xl font-medium tracking-[-2.4px]"
              dangerouslySetInnerHTML={{
                __html: title,
              }}
            >
            </div>
            <p class="text-base md:text-[18px] leading-[150%]">
              {description}
            </p>
            <div class="flex flex-col items-center lg:items-start lg:flex-row gap-4">
              {cta?.map((item) => (
                ...
                >
                  ...
                  <span class="relative font-medium text-secondary-content lg:text-[20px]">
                    {item?.text}
                  </span>
                </a>
              ))}
