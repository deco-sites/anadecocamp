...
function ProductShelf({
  ...
  return (
    <div class={`w-full container py-8 flex flex-col gap-6 lg:py-10 md:${layout?.tamanhoDoContainerHorizontal ? layout.tamanhoDoContainerHorizontal : '' }`}>
      <Header
        title={title || ""}
